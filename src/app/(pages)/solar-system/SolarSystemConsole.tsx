...
export function SolarSystemConsole() {
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              >
                {locale === "en"
                  ? "Sun · 8 planets · 1 dwarf"
                  : "Sol · 8 planetas · 1 anão"}
              </p>
            </div>
          </div>
          ...
          <span className="text-[10px] font-mono uppercase tracking-[0.25em] text-muted-foreground/60 flex items-center gap-2">
            ...
            {locale === "en" ? "Not to scale" : "Fora de escala"}
          </span>
        </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <h3
                          className="font-serif text-base font-bold leading-tight truncate group-hover:text-accent transition-colors"
                    ...
                    <div className="flex items-center justify-between text-[10px] font-mono text-muted-foreground/70">
                      <span>
                        Ø{" "}
                        {body.diameterKm.toLocaleString(
