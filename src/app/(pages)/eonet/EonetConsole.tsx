        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="w-full lg:w-60 shrink-0">
            <div className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-[0.3em] text-muted-foreground/80 mb-3">
              ...
              {locale === "en" ? "Classification" : "Classificação"}
            </div>
                    ...
                    style={
                      active
                        ? {
                            ...
                            color: cfg.color,
                            borderColor: `color-mix(in oklch, ${cfg.color} 35%, transparent)`,
                          }
                        : {
                            background: "transparent",
                            color: "var(--muted-foreground)",
          ...
          <div className="grow">
            {error && (
              <CommsFailure
                message={
                  locale === "en"
                    ? "Lost link to Earth observation satellites."
                    : "Perda de sinal com satélites de observação."
                }
                onRetry={() => refetch()}
              />
            )}
            {isLoading && (
              <TelemetrySpinner
                ...
                phases={
                  locale === "en"
                    ? [
                        "Pinging observation satellites",
                        "Triangulating active events",
                        "Compiling regional anomalies",
                      ]
                    : [
                        "Sondando satélites de observação",
                        "Triangulando eventos ativos",
                        "Compilando anomalias regionais",
                      ]
                }
              />
            )}
